...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "kb_upload_hint": { tr: "PDF, TXT veya DOCX dosyası yükleyin (maks. 5MB)", en: "Upload PDF, TXT or DOCX file (max 5MB)" },
  "kb_uploading": { tr: "Yükleniyor...", en: "Uploading..." },
  "kb_reading_file": { tr: "Dosya okunuyor...", en: "Reading file..." },
  "kb_file_too_large": { tr: "Dosya çok büyük (maks. 5MB)", en: "File too large (max 5MB)" },
