...
interface ChannelStats {
  ...
  telegram: { sent: number; received: number; connected: boolean }
  whatsapp_personal: { sent: number; received: number; connected: boolean }
}
...
export default function DashboardPage() {
  ...
  const [channelStats, setChannelStats] = useState<ChannelStats>({
    ...
    telegram: { sent: 0, received: 0, connected: false },
    whatsapp_personal: { sent: 0, received: 0, connected: false },
  })
