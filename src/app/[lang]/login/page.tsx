        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12 w-full">
          ...
          <div className="flex items-center gap-5 mt-12 pt-8 border-t border-white/10">
            <div className="flex items-center gap-2 text-sm text-emerald-200/70">
              <svg viewBox="0 0 20 20" fill="currentColor" className="w-4.5 h-4.5 text-emerald-300"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd"/></svg>
